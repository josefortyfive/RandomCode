...
import doomtest2.Test.LineDef;
import doomtest2.Test.Node;
import doomtest2.Test.Sector;
import doomtest2.Test.Seg;
import doomtest2.Test.SideDef;
import doomtest2.Test.Subsector;
import doomtest2.vector.Vec2;

import static doomtest2.Test.lineDefs;
import static doomtest2.Test.segs;
import static doomtest2.Test.vertexes;
...
//        wadFile += "DOOM1.WAD";
        ...
        //String wadFile = "C:/Users/Edmar/Documents/Eclipse Workplace/Project/RandomCode/src/doomtest2/DOOM1.WAD";
        String wadFile = "./res/DOOM1.WAD";
...
//        Test.extractSectors(Test.bb, 8);
    ...
    private void drawLineDefs(Graphics2D g) {
        ...
        for (int i = 0; i < lineDefs.size(); i++) {
            ...
            Point v2 = vertexes.get(lineDef.endVertex);
